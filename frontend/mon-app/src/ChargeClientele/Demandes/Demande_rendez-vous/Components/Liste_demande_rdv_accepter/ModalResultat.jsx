          ...
          <br />
            ...
            <div>
              {stateRes.map((c)=>(
                  ...
                  <div>
                        <p>Bonjour monsieur <b>{c.id_cdc.nom} {c.id_cdc.prenom}</b> Il ya un rendez-vous avec monsieur <b>{c.id_user.id_client.nom} {c.id_user.id_client.prenom}</b>    à la date <b>{c.id_demande.date}</b> a l'heure <b>{c.id_demande.heure}</b> Voici lien Meet  :  <b>                        <a href={c.link} target="_blank"><img src="/img/icons8-link (1).gif" className="link_meet"></img>  </a>
</b></p>

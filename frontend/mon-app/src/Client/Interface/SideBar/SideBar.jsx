          ...
          <div className="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul className="navbar-nav">
              <li className="nav-item">
                <Link to ={"/client/main"} className="nav-link  " href="../pages/TableauDebord.html">
                  ...
                  <span className="material-icons-outlined">Tableau de bord</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link to={'/client/comptes'} className="nav-link  " >
                  <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center" style={{width: '3em', height: '3em'}}>
              ...
              <li className="nav-item">
                <Link to ={'/client/cartes'} className="nav-link  " >
                  <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center" style={{width: '3em', height: '3em'}}>
                    <img src="/img/icons8-cards-64.png" width="23px" alt="" />
              ...
              <Link to={'/client/virements'} className="nav-link  " >
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center" style={{width: '3em', height: '3em'}}>
                    <img src="/img/hand-coins-svgrepo-com.svg" alt="" style={{width: "2em"}}/>
                    <title>settings</title>
                  </div>
                  <span className="nav-link-text ms-1">Virements</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link to ={'/client/demandes'} className="nav-link  " >
                  <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center" style={{width: '3em', height: '3em'}}>
              ...
              <li className="nav-item">
                  ...
                  <span className="nav-link-text ms-1">Parametres</span>
                  </Link>
              </li>

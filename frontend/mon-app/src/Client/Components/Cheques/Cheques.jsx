                        ...
                        <div>
                          <div className="card-body pt-4 p-3">
                            <ul className="list-group">
                              ...
                              <div className='bloc1'>
                                <div className='bloc2'>
                                      <img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-cheque-banking-flaticons-lineal-color-flat-icons-4.png" alt="erreur_1"  className='bloc3' />
                                      <span>Chéques émis</span>
                                    </div>
                                    <img src="https://img.icons8.com/dusk/80/4a90e2/circled-right.png" alt="erreur_1" style={{width: '40px'}} />                                
                                  </div></li></Link>
                              <li className="bloc4 border-0  p-4 mb-2 bg-gray-100 border-radius-lg" >
                              <div className='bloc1'>
                                <div className='bloc2'>
                                    <img src="https://img.icons8.com/external-soft-fill-juicy-fish/60/000000/external-cheque-economy-soft-fill-soft-fill-juicy-fish.png" alt="erreur_1" className='bloc3' />
                              ...
                              <div className='bloc1'>
                                <div className='bloc2'>
                                    <img src="https://img.icons8.com/ultraviolet/50/000000/literature.png" alt="erreur_1" className='bloc3' />

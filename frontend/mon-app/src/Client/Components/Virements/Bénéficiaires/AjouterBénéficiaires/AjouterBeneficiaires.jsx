...
const AjouterBeneficiaires = (props) =>{
  ...
  const handleFormSubmit = async (event) => {
    try {
      ...
      const data = await axios.post(
        "http://localhost:4000/api/beneficiaire/add",
        props.valuesInput
      );
      ...
      const preventState = props.Listebeneficiaires;
      preventState.push(data.data);
      props.setListeBeneficiaires(preventState);
    } catch (error) {
    ...
    <div>
      ...
      >
        <div className="auth-form-light text-left p-5">
          <h3 className="font-weight-light">Ajouter un Bénéficiaire </h3>
          <br />
          <form
            className="pt-3"
              ...
              <div>
                <div className="bloc_np">
                  <input
                    ...
                    name="nom"
                    required
                    placeholder="Nom prénom bénéficiaire "
...
export default AjouterBeneficiaires;
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const res = await axios.get(
        "http://localhost:4000/api/carte/bancaire/liste"
      );
      setPosts(res.data);
    };
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="row">
              {posts.map((c) => (
                <div
                  className="col-xl-4 mb-xl-0 mb-2"
                ...
                >
                  <div className="card bg-transparent shadow-xl">
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${
                          "http://localhost:4000/api/type/carte/getImage/" +
                          c.id_demande_carte.id_type_carte._id
                        })`,
                        marginBottom: "10px",
                      }}
                    >
                      ...
                      <div className="card-body position-relative z-index-1 p-3">
                        <div>
                          <img
                            class="contactless"
                            src="/img/wifi-signal.svg"
                            style={{ width: "2em" }}
                          />

                          <h6 className="text-white mt-2 mb-4 pb-2">
                        ...
                        <div className="rib_img">
                          <img
                            class="chip"
                            src="/img/chip.svg"
                            style={{ width: "2em", marginBottom: "50px" }}
                          />
                        ...
                        <div className="d-flex">
                          <div className="exp">
                            <div>
                              <h6 className="text-white mt-2 mb-4 pb-2">
                                {c.id_user.id_client.prenom}{" "}
                                {c.id_user.id_client.nom}
                              </h6>
                              <h6 class="card-expire">
                                EXPIRE{" "}
                                {dateformat(c.date_expiration, "dd mmmm yyyy")}{" "}
                              </h6>
                            </div>
                          </div>

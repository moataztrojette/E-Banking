...
const ModalResultat = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost:4000/api/carte/bancaire/find/" +
          props.stateIdDemande._id
      )
      .then((res) => {
                ...
                <div>
                  {c.id_demande_carte.etat_demande == "valider" ? (
                    <p>
                      ...
                      votre demande de carte bancaire est <b>validée</b> ,
                      veuillez contacter votre agance à la date <b>{c.date}</b>
                    </p>
                  ) : (
                    <> </>
                  )}

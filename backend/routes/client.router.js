...
const {inscription,connexion,deconnexion,findCompte,findall,changePassword,recherche_compte_ac,find_compte_user_ac,desactiver_compte,activer_compte} = require("../controllers/client.c")

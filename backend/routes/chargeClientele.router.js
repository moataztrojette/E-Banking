...
const {consulter_informations_personnelles,Créer_son_compte_personne,se_connecter,se_deconnecter,consulter_les_charges_clienteles_par_agence,chercher_cdc_par_mot_cle_cdc,consulter_les_charges_clienteles} = require("../controllers/chargeClientele")
const { isLogin } = require("../middleware/auth")
router.post('/connexion',se_connecter)
router.post('/deconnexion',se_deconnecter)
router.post('/inscription',Créer_son_compte_personne)
